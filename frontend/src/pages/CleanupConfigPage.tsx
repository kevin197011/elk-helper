...
import { Card, Form, InputNumber, Switch, Button, Space, Typography, Spin, App } from 'antd';
import {
  SaveOutlined,
  DeleteOutlined,
  CheckCircleOutlined,
  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
        <div>
          <Title level={4} style={{ margin: 0 }}>清理任务配置</Title>
          <Text type="secondary">配置定时清理历史告警数据</Text>
        </div>
        <Button
          danger
          icon={<DeleteOutlined />}
